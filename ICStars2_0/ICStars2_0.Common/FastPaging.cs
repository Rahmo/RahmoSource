...
namespace ICStars2_0.Common
{
    ...
    public class FastPaging
    {
        ...
        public string OverOrderByTableName
        {
        ...
        public string Build2005()
        {
            ...
            {
                OverOrderBy = string.Format("{2}.{0} {1}", this.PrimaryKey, GetSortType(this.Ascending), string.IsNullOrEmpty(OverOrderByTableName) ? this.TableReName : OverOrderByTableName);
            }
