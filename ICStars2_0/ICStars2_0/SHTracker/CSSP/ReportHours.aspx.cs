...
{
    [Authorize(Roles = "CSSP,admin_cssp")]
    public partial class ReportHours : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(Request.QueryString["id"], out id))
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    txtEngagementDescription.Text = CurrentServiceHours.EngagementDescription;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/SHTracker/CSSP/ReportHoursSuccess.htm");
        }
    }
}