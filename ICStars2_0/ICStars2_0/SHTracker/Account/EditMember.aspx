<%@ Page Title="" Language="C#" MasterPageFile="~/SHTracker/_Layout.Master" AutoEventWireup="true" CodeBehind="EditMember.aspx.cs" Inherits="ICStars2_0.SHTracker.Account.EditMember" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnAddCBO").click(function () {
                ...
                if (checkCboIsExist()) {
                    alert("This cbo is exist, please select another one!");
                    return false;
                }
            ...
            $("#btnDeleteCBO").click(function () {
                ...
                msg.prepend("<li><em>Are you sure to delete cbo below?</em></li>");
                msg = msg.html();
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <fieldset id="fleft">
        ...
        <p>
            <asp:Button ID="btnSubmit" OnClick="btnSubmit_Click" runat="server" OnClientClick="return checkForm();" Text="Submit" />
        </p>
    </fieldset>
    <fieldset id="fright">
        <legend>cbo</legend>
        ...
        <div id="mycbo" class="editor-field">
            <ul>
                <% foreach (CBO cbo in UserCboCollection)
                   {
                %><li>
                    <input type="checkbox" name="CBOIDList" value="<%=cbo.ID %>" /><%=cbo.Name %></li>
                <%
                   } %>
            </ul>
        </div>
    ...
    <fieldset id="fright2">
        ...
        <div id="mycourse" class="editor-field">
            <ul>
                <% foreach (Course course in UserCourseCollection)
                   {
                %><li>
                    <input type="checkbox" name="CourseIDList" value="<%=course.ID %>" /><%=string.Format("{0}--{1}--{2}", course.Subject, course.CatalogNumber, course.InstructorName)%></li>
                <%
                   } %>
            </ul>
        </div>
