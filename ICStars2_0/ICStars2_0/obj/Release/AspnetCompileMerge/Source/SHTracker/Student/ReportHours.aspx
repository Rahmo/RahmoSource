<%@ Page Title="" Language="C#" MasterPageFile="~/SHTracker/_Layout.Master" AutoEventWireup="true" CodeBehind="ReportHours.aspx.cs" Inherits="ICStars2_0.SHTracker.Student.ReportHours" %>
...
<div class="editor-label">
        ...
        <div class="editor-field">
            ...
            <asp:ListItem Value="CBO Contact">CBO Contact</asp:ListItem>
        ...
        <div class="editor-field">
            <asp:TextBox ID="txtNotes" runat="server" CssClass="required"></asp:TextBox>
        </div>
