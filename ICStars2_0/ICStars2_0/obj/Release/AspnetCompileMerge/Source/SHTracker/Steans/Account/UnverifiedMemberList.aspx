<%@ Page Title="" Language="C#" MasterPageFile="~/SHTracker/_Layout.Master" AutoEventWireup="true" CodeBehind="UnverifiedMemberList.aspx.cs" Inherits="ICStars2_0.SHTracker.Steans.Account.UnverifiedMemberList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="center" valign="top">
             ...
             <td  align="center">
             <span>
             <%#(bool)Eval("Status") ? "available" : "unavailable"%>
               </span>
            </td>
