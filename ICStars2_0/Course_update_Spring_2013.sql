...
select 'Alliance for Community Peace (Wayman)','509 W. Elm Street Chicago, Illinois 60610','ANITA','STEVENSON','1- 312-943-8531','ANITASTEVENSON.ACP@GMAIL.COM' union all
...
select '826CHI','1331 N Milwaukee','Kendra ','Wilkerson','(773) 772-8108','kendra@826chi.org' union all
...
select name,[address],FirstName,LastName,Email,Phone From newcbo
where name not in(select name from cbo)