<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/SHTracker/_Layout.Master" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="ICStars2_0.SHTracker.Steans.Internship.Settings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
  <h2>Community Intership Email Sending Settings</h2>
    <table class="toolbar">
        <tr>
