<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/SHTracker/_Layout.Master" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="ICStars2_0.SHTracker.Steans.Account.Settings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <h2>New Register Email Sending Settings</h2>
        <table class="toolbar">
        <tr>
