...
namespace Commengdpu.BusinessLayer.Provider
{
    ...
    /// created by li hui
    /// </summary>
    public class CommengdpuRoles : BaseRoles, IRoles, ISingletonRegister
    {
        /// <summary>
        ...
        public override string[] FindUsersInRole(string roleName, string usernameToMatch)
        {
            ...
            return DB_RoleManager.FindUsersInRole(roleName, usernameToMatch);
        }
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            return DB_RoleManager.GetRolesForUser(username);
        }
        ...
        public override string[] GetUsersInRole(string roleName)
        {
            ...
            return DB_RoleManager.GetUsersInRole(roleName);
        }
